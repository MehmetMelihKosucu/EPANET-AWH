...
void Pump::findHeadLoss(Network* nw, double q)
{
    ...
    else
    {
		...
		inertialTerm = MIN_GRADIENT; // Approximate value for pump inertial term
    }
}
...
double Pump::getSegmentLength(double desiredSegmentLength, double tstep) const {
    return 0.0;  // Pumps do not support segmentation
}
